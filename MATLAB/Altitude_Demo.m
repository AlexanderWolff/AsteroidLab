%% Toy used to practice altitude-control in a simplified environment


Control = 'Altitude';

%% Initialising
Joint.Shoulder = deg2rad(40);
Joint.Elbow    = deg2rad(80);
...
if strcmp(Control,'Altitude')
    Altitude.new = Altitude.start * 0.2;
...
% Difference
dJw = Start.Angle.d - Stop.Angle.d;
